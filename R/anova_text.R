...
anova_text <- list(
  list(
    filename = "gender_fitness_expenditures",
  ...
  list(
    filename = "area_broadband_satisfaction",
  ...
  list(
    filename = "education_annual_earnings",
  ...
  list(
    filename = "time_coffee_consumption",
  ...
  list(
    filename = "age_video_game_preference",
  ...
  list(
    filename = "season_hotel_booking_rates",
  ...
  list(
    filename = "experience_job_satisfaction",
  ...
  list(
    filename = "employment_professional_development",
  ...
  list(
    filename = "education_mode_student_performance",
  ...
  list(
    filename = "film_genre_viewer_ratings",
  ...
  list(
    filename = "physical_activity_sleep_quality",
  ...
  list(
    filename = "school_type_student_scores",
  ...
  list(
    filename = "vehicle_type_fuel_efficiency",
  ...
  list(
    filename = "coffee_type_cognitive_responses",
  ...
  list(
    filename = "dietary_habits_cholesterol_levels",
  ...
  list(
    filename = "mobile_os_app_purchase_frequency",
  ...
  list(
    filename = "industry_employee_turnover",
  ...
  list(
    filename = "regional_spending_leisure_activities",
  ...
  list(
    filename = "leisure_activity_stress_reduction",
  ...
  list(
    filename = "academic_year_extracurricular_participation",
